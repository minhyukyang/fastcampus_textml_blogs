> lovit(김현중님)의 github에서 패스트캠퍼스 강의를 위한 글을 보고 정리한 내용입니다.
...
- **형태소 분석(morphological analysis)** 은 품사 판별과 자주 혼동되는 개념, 형태소란 의미를 지니는 최소 단위로, (1) 자립형태소 / 의존형태소 로 나뉘기도 하며, (2) 실질형태소와 형식형태소로 나뉘기도 합니다.
